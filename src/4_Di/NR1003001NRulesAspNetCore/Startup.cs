...
using NR1003001NRulesAspNetCore.MiddleWare;
using NR1003001NRulesAspNetCore.NRulesNugetSource;
using NR1003001NRulesAspNetCore.Services;
using NRules.Extensibility;
using System;

namespace NR1003001NRulesAspNetCore
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //AspNetCoreDependencyResolver

            //services.AddScoped(ser => (IPersonService)ser.GetService(typeof(IPersonService)));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //var personService = app.ApplicationServices.GetRequiredService(typeof(IPersonService));
