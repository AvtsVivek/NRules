...
function copy_uifiles(cb) {
    src('Ui/js/**').pipe(dest('wwwroot/js/'));
    src('Ui/css/**').pipe(dest('wwwroot/css/'));
    src('Ui/favicon.ico').pipe(dest('wwwroot/'));
    cb();
}
...
exports.build = build;
exports.copy_uifiles = copy_uifiles;
...
exports.default = series(clean, build, copy_rootfiles, copy_jquery,
    ...
    copy_bootstrap, trial_console_log, copy_uifiles);
